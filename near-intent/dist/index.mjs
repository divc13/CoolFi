...
import { keyStores, utils, connect, KeyPair, transactions } from 'near-api-js';
import '@scure/base';
...
async function crossChainSwap(params) {
  ...
  const keyPair = utils.KeyPair.fromString(function_access_key);
  ...
  const nonce = new Uint8Array(crypto2.randomBytes(32));
